...
export const FormReserved = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={0} display="flex" justifyContent={"center"} sx={{backgroundColor:'#F8F8F8'}}>
                    ...
                    <Grid container spacing={2} sx={{ pt: 4 }}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                error={!!errors.passport}
                                helperText={errors.passport ? t("La Cantidad de Personas es requireda") : ""}
                            />
                        </Grid>
